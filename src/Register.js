...
export default function Register() {
  ...
  function handleSubmit(e) {
    ...
    // const url = "http://anonymousbackend.heartstories.fireswitch.com.ng/register.php"
    const data = {
      username: username,
      password: password
    };
    axios
      .post("http://anonymousbackend.heartstories.fireswitch.com.ng/register.php", {
        params: data
      })
      .then((res) => {
  ...
  return (
    <React.Fragment>
      ...
      <main>
       ...
       <Typography variant="h3" className={classes.typo}>Register</Typography>
        ...
        <div className={classes.formInputs}>
          <label  style={{width: "100%"}}><p className={classes.textStylingInputs}>Your Usename</p>
            <input name='username' type='text' onChange={(e) => setUsername(e.target.value)} style={{backgroundColor: "#0D123C"}} placeholder="Enter username"
          ...
          <Link  className={classes.link}>
                    <Button variant="contained" color="secondary" type="submit" onClick={handleSubmit} className={classes.btnLink}>
                      Register
                    </Button>
                  </Link>
