    ...
    <React.Fragment>
      ...
      <BottomNavigation
        ...
        >
          ...
          <BottomNavigationAction label="Messages" icon={<FavoriteIcon />} onClick={goToMessages} style={{color: "#fff", backgroundColor: "#FF7C9C"}} />
          <BottomNavigationAction label="Profile" icon={<ArchiveIcon />} onClick={goToProfile} style={{color: "#fff"}} />
        </BottomNavigation>
